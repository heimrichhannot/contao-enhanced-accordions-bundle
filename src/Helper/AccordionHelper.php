...
namespace HeimrichHannot\EnhancedAccordionsBundle\Helper;
...
class AccordionHelper
{
    ...
    public function structureAccordionStartStop(array $data, string $prefix = 'accordion_'): array
    {
     ...
     */
    public function structureAccordionSingle(array $data, string $prefix = 'accordion_'): array
    {
        if (!isset($data['id']) || !isset($data['pid']) || !isset($data['ptable'])) {
            return $data;
        }
